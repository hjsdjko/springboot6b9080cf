<template>
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="零食名称" prop="lingshimingcheng">
					<el-input v-model="ruleForm.lingshimingcheng" placeholder="零食名称" clearable  :readonly="ro.lingshimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="零食名称" prop="lingshimingcheng">
					<el-input v-model="ruleForm.lingshimingcheng" placeholder="零食名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="零食分类" prop="lingshifenlei">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.lingshitupian" label="零食图片" prop="lingshitupian">
					<file-upload
						tip="点击上传零食图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.lingshitupian" label="零食图片" prop="lingshitupian">
					...
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.lingshitupian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="零食规格" prop="lingshiguige">
					<el-input v-model="ruleForm.lingshiguige" placeholder="零食规格" clearable  :readonly="ro.lingshiguige"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="零食规格" prop="lingshiguige">
					<el-input v-model="ruleForm.lingshiguige" placeholder="零食规格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="零食品牌" prop="lingshipinpai">
					<el-input v-model="ruleForm.lingshipinpai" placeholder="零食品牌" clearable  :readonly="ro.lingshipinpai"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="零食品牌" prop="lingshipinpai">
					<el-input v-model="ruleForm.lingshipinpai" placeholder="零食品牌" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="零食详情" prop="lingshixiangqing">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.lingshixiangqing" label="零食详情" prop="lingshixiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.lingshixiangqing"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='lingshitupian'){
							this.ruleForm.lingshitupian = obj[o];
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.lingshixiangqing = this.ruleForm.lingshixiangqing.replace(reg,'../../../springboot6b9080cf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    // 提交
    onSubmit() {
	if(this.ruleForm.lingshitupian!=null) {
		this.ruleForm.lingshitupian = this.ruleForm.lingshitupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    lingshitupianUploadChange(fileUrls) {
	    this.ruleForm.lingshitupian = fileUrls;
    },
  }
};
</script>

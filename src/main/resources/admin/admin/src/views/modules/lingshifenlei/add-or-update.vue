<template>
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="零食分类" prop="lingshifenlei">
					<el-input v-model="ruleForm.lingshifenlei" placeholder="零食分类" clearable  :readonly="ro.lingshifenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="零食分类" prop="lingshifenlei">
